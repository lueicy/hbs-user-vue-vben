  ...
  >
    ...
    <template #toolbar>
      ...
      <a-button @click="AddModal"> 
            <span class="iconify" :style="{display:'inline-block',margin:'0 10px 4px 0'}" data-icon="ph:apple-logo"></span>
         <span>
           添加升级信息 
         </span>
         </a-button>
...
import { iosInfoList,DeleteUpgradeInfo } from '/@/api/demo/table';
...
export default defineComponent({
  components: { TableAction, Modal4, BasicTable,  },
  setup() {
